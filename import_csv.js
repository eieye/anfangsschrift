// NEW 08-JAN-23 // BUGFIX
// FIX // OCCASIONAL "UNDEFINED" POINTS IN PARSING
	// STRIP EMPTY LINES // REMOVE DBL LINEBREAK
// FIX // BUG WAS MISSING TO DETECT A NEW STROKE (NO "M" INSERTED)
// NEEDED TO BE X #OR# Y (NOT X #AND# Y) IN LINE #101#
...
// GLOBAL SCOPE
  let csv_import_raw;
	...
	//let svg_composite = "";																															// LINE#139# // (RETURN CREATES TEMP VAR)
...
// IF ONLY #ONE# COORDINATE (X #OR# Y) IS DIFFEERENT IT CAN NOT BE A CONTINUOUS PATH // LINE #101#
...
`; // (NEWLINE)
	...
	//console.log(path);
	svg_composite = concatStrokeToSVG(path); // LINE#139#																// TYPING/GLOBAL SCOPE IS AUTO FOR RETURN ARG (?)
...
function writeToHTML(svg_composite) {
	...
	console.log(svg_composite.toString());
